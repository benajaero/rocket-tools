...
[![Tests](https://img.shields.io/badge/tests-700%20passing-brightgreen)](tests/)
...
|------------|--------------|
| **75 MCP Tools** | Exposed via [FastMCP](https://github.com/modelcontextprotocol/python-sdk) — AI agents can call aerospace computations with structured inputs and validated outputs |
...
| **Orbital Mechanics** | Hohmann transfers, vis-viva speed, plane-change ΔV, Keplerian period, universal-variable Lambert solver, and state-vector ↔ classical-orbital-element conversion — validated vs Curtis/Vallado |
...
This repository exposes 75 tools via FastMCP. The key ones by domain are below; for the
