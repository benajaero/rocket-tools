...
[![Tests](https://img.shields.io/badge/tests-710%20passing-brightgreen)](tests/)
...
|------------|--------------|
| **76 MCP Tools** | Exposed via [FastMCP](https://github.com/modelcontextprotocol/python-sdk) — AI agents can call aerospace computations with structured inputs and validated outputs |
...
| **Orbital Mechanics** | Hohmann transfers, vis-viva speed, plane-change ΔV, Keplerian period, universal-variable Lambert solver, state-vector ↔ classical-orbital-element conversion, and time-of-flight state propagation — validated vs Curtis/Vallado |
...
This repository exposes 76 tools via FastMCP. The key ones by domain are below; for the
