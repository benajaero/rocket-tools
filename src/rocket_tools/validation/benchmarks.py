...
_BENCHMARKS: dict[str, dict[str, Any]] = {
    ...
    "coe_from_state_curtis_4_3": {
        "tool_name": "orbital_elements_from_state",
        "inputs": {
        ...
        "expected": {
            "eccentricity": 0.1712,
            "inclination_deg": 153.2,
            "raan_deg": 255.3,
            "argument_of_perigee_deg": 20.07,
            "true_anomaly_deg": 28.45,
            "semi_major_axis_m": 8788000.0,
        },
        "tolerance": 0.002,
        "reference": (
